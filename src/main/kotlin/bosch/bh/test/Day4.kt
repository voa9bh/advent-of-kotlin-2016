...
//    println("result4 = $result4")
  ...
  private fun part1(lines: List<String>): Int {
    return lines.count { line ->
      val (input, checksum) = splitInput(line)
      println("input $input checksum $checksum")
      val eachCount = input.groupingBy { it }.eachCount()
      println("eachCount $eachCount")
      ...
      return@count checksum == sorted
    }
  }

  private fun splitInput(line: String) : Pair<String,String> {
